<template>
  <div class="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden">
    <!-- Header principal -->
    <div class="bg-gradient-to-r from-blue-50 to-indigo-50 px-6 py-5 border-b border-gray-200/60">
      <div class="flex items-center justify-between">
        <div class="flex items-center space-x-4">
          <div class="flex items-center space-x-3">
            ...
            <div>
              <h1 class="text-xl font-bold text-gray-900 tracking-tight">Pedidos</h1>
              <p class="text-sm text-gray-600">Gestión de pedidos del sistema</p>
            </div>
          </div>
        </div>
        ...
        <div class="flex items-center space-x-3">
          <button
            @click="onCrearNuevo"
            class="inline-flex items-center px-4 py-2 bg-blue-600 text-white text-sm font-medium rounded-lg hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 transition-all duration-200 shadow-sm hover:shadow-md"
          >
            <svg class="w-4 h-4 mr-2" fill="none" viewBox="0 0 24 24" stroke="currentColor">
              <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 4v16m8-8H4" />
            </svg>
            {{ config.createButtonText || 'Nuevo Pedido' }}
          </button>
        </div>
      </div>
    </div>
    ...
    <div class="px-6 py-4 bg-gray-50/30 border-b border-gray-200/40">
      <div class="grid grid-cols-2 md:grid-cols-4 gap-4">
        ...
        <div class="bg-white p-4 rounded-lg border border-gray-200/50 shadow-sm">
          <div class="flex items-center justify-between">
            <div>
              <p class="text-sm font-medium text-gray-600">Enviados a Venta</p>
              <p class="text-2xl font-bold text-indigo-600">{{ enviado_venta }}</p>
            </div>
        ...
        <div class="flex-1 max-w-md">
          <div class="relative">
            ...
            <input
              v-model="searchTerm"
              type="text"
              :placeholder="config.searchPlaceholder || 'Buscar pedidos...'"
              class="block w-full pl-10 pr-3 py-2 border border-gray-300 rounded-lg leading-5 bg-white placeholder-gray-500 focus:outline-none focus:placeholder-gray-400 focus:ring-1 focus:ring-blue-500 focus:border-blue-500 transition-colors duration-200"
        ...
        <div class="flex items-center space-x-3">
          ...
          <div class="relative">
            <select
              ...
              class="block w-full pl-3 pr-10 py-2 text-base border border-gray-300 focus:outline-none focus:ring-1 focus:ring-blue-500 focus:border-blue-500 rounded-lg transition-colors duration-200 bg-white"
