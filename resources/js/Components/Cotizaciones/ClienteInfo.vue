<template>
  <div class="bg-white rounded-xl border border-gray-200 shadow-sm overflow-hidden">
    ...
    <div class="relative p-6">
      ...
      <!-- Estado vacío -->
      <div v-else-if="!busquedaCliente" class="mt-6 p-6 border-2 border-dashed border-gray-300 rounded-lg text-center">
...
const emit = defineEmits(['cliente-seleccionado', 'crear-nuevo-cliente', 'limpiar-cliente']);
