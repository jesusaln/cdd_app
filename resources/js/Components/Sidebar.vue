<template>
    <aside
        ...
        class="bg-gray-800 text-white absolute left-0 top-0 bottom-0 z-10 transition-all duration-300 ease-in-out overflow-y-auto"
    >
        <nav>
            <ul>
                ...
                <NavLink href="/mantenimientos" icon="tools">Mantenimientos</NavLink>
            </ul>
        </nav>
    </aside>
</template>
