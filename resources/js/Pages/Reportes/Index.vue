            ...
            <div class="p-6">
                ...
                <div v-show="activeTab === 'prestamos'">
                    <div class="mb-6">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-4 gap-4">
                            <div class="bg-blue-50 p-4 rounded-lg">
                                <div class="text-2xl font-bold text-blue-600">{{ prestamosTotales || 0 }}</div>
                                <div class="text-sm text-blue-600">Total Préstamos</div>
                            </div>
                            <div class="bg-green-50 p-4 rounded-lg">
                                <div class="text-2xl font-bold text-green-600">{{ prestamosActivos || 0 }}</div>
                                <div class="text-sm text-green-600">Préstamos Activos</div>
                            </div>
                            <div class="bg-purple-50 p-4 rounded-lg">
                                <div class="text-2xl font-bold text-purple-600">{{ prestamosCompletados || 0 }}</div>
                                <div class="text-sm text-purple-600">Préstamos Completados</div>
                            </div>
                            <div class="bg-orange-50 p-4 rounded-lg">
                                <div class="text-2xl font-bold text-orange-600">{{ montoTotalPrestado || formatCurrency(0) }}</div>
                    ...
                    <div class="text-center py-8">
                        ...
                        <div class="bg-gray-50 p-6 rounded-lg max-w-2xl mx-auto">
                            <div class="text-center">
                                ...
                                <Link
                                    href="/reportes/prestamos-por-cliente"
...
// Datos de préstamos (simulados por ahora)
