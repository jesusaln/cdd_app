        ...
        <div class="bg-white shadow-sm rounded-lg overflow-hidden">
            ...
            <div class="border-b border-gray-200 px-6 py-4">
                <div class="flex items-center justify-between">
                    <div>
                        <h1 class="text-2xl font-semibold text-gray-900">Reporte de Productos</h1>
                        <p class="text-sm text-gray-600 mt-1">Productos más vendidos y análisis de ganancias</p>
                    </div>
                    <Link
                        href="/reportes"
            ...
            <div class="p-6">
                <div class="grid grid-cols-1 md:grid-cols-4 gap-4 mb-6">
                    ...
                    <div class="bg-green-50 p-4 rounded-lg">
                        <div class="text-2xl font-bold text-green-600">{{ estadisticas.productos_vendidos }}</div>
