<template>
  ...
  <div class="min-h-screen bg-gray-50 py-8">
    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
      ...
      <div class="mb-6">
        <div class="flex items-start justify-between gap-4">
          <div>
            ...
            <p class="mt-2 text-sm text-gray-600">Actualiza los detalles de tu actividad. Los campos marcados con * son obligatorios.</p>
          </div>
      ...
      <!-- Formulario -->
      <form @submit.prevent="submit" class="bg-white rounded-2xl shadow-sm border border-gray-200 p-6">
        ...
        <div class="mt-8 flex flex-col sm:flex-row gap-3 sm:items-center sm:justify-between">
          ...
          <div class="flex gap-3">
            <button type="button" @click="submit('stay')" :disabled="form.processing" class="px-5 py-2.5 rounded-lg border bg-white hover:bg-gray-50 disabled:opacity-50">Guardar cambios</button>
