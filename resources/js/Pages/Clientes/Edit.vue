        ...
        <div class="border-b border-gray-200 pb-6">
          ...
          <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <FormField
              ...
              @clear-error="form.clearErrors('email')"
              required
            />
        ...
        <div class="border-b border-gray-200 pb-6">
          ...
          <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <FormField
              ...
              type="select"
              id="regimen_fiscal"
              :options="selectOptions(props.catalogs.regimenesFiscales, true)"
...
const initialValues = { ...props.cliente };
...
const resetForm = () => {
  Object.keys(initialValues).forEach(k => form[k] = initialValues[k]);
  form.clearErrors();
