        ...
        <form @submit.prevent="submit" class="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div class="space-y-4 col-span-2">
                ...
                <div>
                    ...
                    <input v-model="form.nombre_razon_social" type="text" id="nombre_razon_social" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm" @blur="convertirAMayusculas('nombre_razon_social')" />
            ...
            <div>
                ...
                <select v-model="form.tipo_persona" id="tipo_persona" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm" @change="validarRFC" required>
...
<div>
    ...
    <p v-if="form.errors.rfc" class="text-red-500 text-sm">{{ form.errors.rfc }}</p>
            ...
            <div>
                ...
                <select v-model="form.regimen_fiscal" id="regimen_fiscal" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm" required>
            ...
            <div>
                ...
                <select v-model="form.uso_cfdi" id="uso_cfdi" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm" required>
            ...
            <div>
                ...
                <input v-model="form.telefono" type="text" id="telefono" maxlength="10" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm" @input="validarTelefono" required />
            ...
            <div>
                ...
                <input v-model="form.calle" type="text" id="calle" maxlength="40" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm" @blur="convertirAMayusculas('calle')" required />
            ...
            <div>
                ...
                <input v-model="form.numero_exterior" type="text" id="numero_exterior" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm" required />
            </div>
            ...
            <div>
                ...
                <input v-model="form.colonia" type="text" id="colonia" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm" @blur="convertirAMayusculas('colonia')" required />
            </div>

            <!-- Código Postal -->
            <div>
                <label for="codigo_postal" class="block text-sm font-medium text-gray-700">Código Postal</label>
                <input v-model="form.codigo_postal" type="text" id="codigo_postal" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm" required />
            </div>

            <!-- Municipio -->
            <div>
                <label for="municipio" class="block text-sm font-medium text-gray-700">Municipio</label>
                <input v-model="form.municipio" type="text" id="municipio" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm" readonly />
            </div>

            <!-- Estado -->
            <div>
                <label for="estado" class="block text-sm font-medium text-gray-700">Estado</label>
                <input v-model="form.estado" type="text" id="estado" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm" readonly />
            </div>

            <!-- País -->
            <div>
                <label for="pais" class="block text-sm font-medium text-gray-700">País</label>
                <input v-model="form.pais" type="text" id="pais" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm" readonly />
            </div>
...
const form = useForm({
    ...
    numero_interior: props.cliente.numero_interior || '', // Aseguramos que no sea null
