                            ...
                            <div class="bg-gray-50 p-4 rounded-lg">
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                    ...
                                    <div>
                                        ...
                                        <p class="mt-1 text-sm text-gray-900">${{ cuenta.compra.total.toFixed(2) }}</p>
                                    </div>
                                    <div>
                            ...
                            <div class="bg-blue-50 p-4 rounded-lg">
                                <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                                    <div>
                                        ...
                                        <p class="mt-1 text-lg font-semibold text-blue-900">${{ cuenta.monto_total.toFixed(2) }}</p>
                                    </div>
                                    <div>
                                        <label class="block text-sm font-medium text-blue-700">Monto Pagado</label>
                                        <p class="mt-1 text-lg font-semibold text-green-600">${{ cuenta.monto_pagado.toFixed(2) }}</p>
                                    </div>
                                    <div>
                                        <label class="block text-sm font-medium text-blue-700">Monto Pendiente</label>
                                        <p class="mt-1 text-lg font-semibold text-red-600">${{ cuenta.monto_pendiente.toFixed(2) }}</p>
                                    </div>
                                </div>
                            </div>
                        </div>
