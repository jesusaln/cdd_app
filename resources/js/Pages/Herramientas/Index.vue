      ...
      <tbody>
        <tr v-for="herramienta in filteredHerramientas" :key="herramienta.id" class="hover:bg-gray-100">
          ...
          <td class="px-4 py-3 flex space-x-2">
            <!-- Botón Ver -->
            <button @click="viewDetails(herramienta)" class="bg-green-500 text-white px-4 py-2 rounded-md hover:bg-green-600">
              Ver
            </button>
            <!-- Botón Editar -->
...
const viewDetails = (herramienta) => {
  console.log('Ver detalles de:', herramienta);
};
