            ...
            <table class="min-w-full divide-y divide-gray-200/60">
              <thead class="bg-gray-50/60">
                <tr>
                  ...
                  <th class="px-6 py-4 text-left text-xs font-semibold text-gray-600 uppercase tracking-wider">Interés</th>
                    ...
                    <td class="px-6 py-4">
                      <div class="flex flex-col space-y-0.5">
                        <div class="text-sm text-gray-900">
                          {{ prestamo.pagos_realizados }} / {{ prestamo.numero_pagos }}
                        </div>
                        <div class="text-xs text-gray-500">
                    ...
                    <td class="px-6 py-4">
                      <div class="flex items-center justify-end space-x-2">
                        ...
                        <select
                          ...
                          @change="cambiarEstado(prestamo, $event.target.value)"
