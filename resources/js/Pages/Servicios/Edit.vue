<template>
    ...
    <div>
        <h1 class="text-2xl font-semibold mb-4">Editar Servicio</h1>
...
// Recibe los datos del servicio y las relaciones desde el backend
const props = defineProps({
    servicio: Object, // Datos del servicio a editar
