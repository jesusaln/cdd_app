    ...
    <div class="min-h-screen bg-gray-50 py-10">
        <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="mb-10 flex items-center justify-between">
                <div>
                    <h1 class="text-4xl font-extrabold text-gray-900 leading-tight">Editar Categoría</h1>
                    <p class="mt-2 text-lg text-gray-600">Modifica la información de esta categoría existente.</p>
                </div>
                <Link
                        ...
                        <div class="flex items-center">
                            <div class="flex-shrink-0">
                                <div class="w-12 h-12 bg-teal-100 rounded-xl flex items-center justify-center shadow-md">
                                    <i class="fas fa-edit text-teal-700 text-xl"></i>
                                </div>
                            </div>
                            <div class="ml-5">
                                <h3 class="text-xl font-semibold text-gray-900">Información de la Categoría</h3>
                                <p class="mt-1 text-sm text-gray-500">Actualiza los detalles de la categoría seleccionada.</p>
                            </div>
                        </div>
                    </div>
            ...
            <div class="mt-10 bg-teal-50 rounded-3xl p-7 border border-teal-200 shadow-md">
                <div class="flex items-start">
                    ...
                    <div class="ml-5">
                        <h3 class="text-xl font-bold text-teal-900 mb-3">Consejos para editar categorías</h3>
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-x-6 gap-y-3 text-base text-teal-800">
                            <div class="flex items-start">
                                ...
                                <span>Asegúrate de que los cambios reflejen el propósito actual de la categoría.</span>
                            </div>
                            <div class="flex items-start">
                                <i class="fas fa-check-circle text-teal-600 mr-2 mt-1 flex-shrink-0"></i>
                                <span>Considera cómo esta edición impactará los servicios asociados.</span>
                            </div>
                            <div class="flex items-start">
                                <i class="fas fa-check-circle text-teal-600 mr-2 mt-1 flex-shrink-0"></i>
...
const submit = () => {
    form.put(route('categorias.update', props.categoria.id), {
        ...
        onError: (errors) => {
            console.error('Error al actualizar:', errors); // Keep for debugging
            notyf.error('Error al actualizar la categoría. Revisa los datos ingresados.');
        },
    });
};
</script>
