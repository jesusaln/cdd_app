    ...
    <div class="min-h-screen bg-gray-50 py-10">
        <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="mb-10 flex items-center justify-between">
                <div>
                    <h1 class="text-4xl font-extrabold text-gray-900 leading-tight">Crear Nueva Categoría</h1>
                    <p class="mt-2 text-lg text-gray-600">Completa la información para agregar una nueva categoría a tu catálogo.</p>
                </div>
                <Link
                ...
                <form @submit.prevent="submit" class="divide-y divide-gray-200">
                    <div class="px-8 py-5 bg-gradient-to-br from-teal-50 to-emerald-50 border-b border-gray-200">
                        <div class="flex items-center">
                            ...
                            <div class="ml-5">
                                <h3 class="text-xl font-semibold text-gray-900">Información de la Categoría</h3>
                                <p class="mt-1 text-sm text-gray-500">Ingresa los detalles principales para tu nueva categoría de servicios.</p>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="space-y-6">
                                <div>
                                    ...
                                    <input
                                        ...
                                        type="text"
                                        id="nombre"
                                        placeholder="Ej: Cortes de Cabello, Manicura y Pedicura"
                                        :class="[
                            ...
                            <div class="space-y-6">
                                <div>
                                    ...
                                    <textarea
                                        ...
                                        id="descripcion"
                                        placeholder="Describe brevemente los tipos de servicios que se agruparán bajo esta categoría, por ejemplo: 'Servicios de peluquería masculina y femenina, incluyendo lavados, cortes, peinados y tratamientos capilares.'"
                                        rows="6"
                                        maxlength="500"
                                ...
                                <div class="bg-gray-50 rounded-2xl p-5 border border-gray-200 shadow-inner">
                                    <h4 class="text-base font-semibold text-gray-700 mb-4 flex items-center">
                                        ...
                                        Vista Previa de la Tarjeta de Categoría
                                    </h4>
                                        ...
                                        <div class="flex items-start justify-between">
                                            <div class="flex-1">
                                                ...
                                                <p class="text-sm text-gray-600 mt-2 line-clamp-3">
                                                    {{ form.descripcion || 'Una descripción concisa de los servicios que se incluyen en esta categoría. Esto ayudará a tus clientes a entender rápidamente de qué trata.' }}
                                                </p>
                                            </div>
                                        </div>
                                    </div>
            ...
            <div class="mt-10 bg-teal-50 rounded-3xl p-7 border border-teal-200 shadow-md">
                <div class="flex items-start">
                    ...
                    <div class="ml-5">
                        <h3 class="text-xl font-bold text-teal-900 mb-3">Consejos para crear una buena categoría</h3>
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-x-6 gap-y-3 text-base text-teal-800">
                            <div class="flex items-start">
                                ...
                                <span>Usa nombres claros y descriptivos que tus clientes entiendan fácilmente.</span>
                            </div>
                            <div class="flex items-start">
                                <i class="fas fa-check-circle text-teal-600 mr-2 mt-1 flex-shrink-0"></i>
                                <span>Sé conciso pero informativo en la descripción; resalta los beneficios.</span>
                            </div>
                            <div class="flex items-start">
                                <i class="fas fa-check-circle text-teal-600 mr-2 mt-1 flex-shrink-0"></i>
                                <span>Evita categorías demasiado amplias o excesivamente específicas.</span>
                            </div>
                            <div class="flex items-start">
                                <i class="fas fa-check-circle text-teal-600 mr-2 mt-1 flex-shrink-0"></i>
                                <span>Agrupa servicios lógicamente para una navegación intuitiva.</span>
                            </div>
                        </div>
                    </div>
                </div>
...
const submit = () => {
    form.post(route('categorias.store'), {
        ...
        onError: () => {
            notyf.error('Error al crear la categoría. Por favor, revisa los datos ingresados.');
        }
    });
};
</script>
