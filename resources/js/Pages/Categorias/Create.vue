<template>
    <div>
        ...
        <!-- Formulario -->
        <form @submit.prevent="crearCategoria" class="space-y-4">
            <!-- Campo Nombre -->
            <div>
            ...
            <div class="flex justify-end space-x-4">
                <Link :href="route('categorias.index')" class="px-4 py-2 bg-gray-300 rounded hover:bg-gray-400 transition duration-300">
                    Cancelar
                </Link>
