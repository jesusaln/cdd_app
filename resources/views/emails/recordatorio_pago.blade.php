    ...
    <div class="container">
        ...
        <div class="warning">
            ...
            <p>Estimado cliente, le recordamos amablemente que aún tenemos pendiente de recibir el pago correspondiente
                a la venta realizada. Le enviamos nuevamente la factura para su referencia y facilitarle el proceso de
                pago.</p>
        </div>
        ...
        @if ($cuenta)
            <div class="info-section">
                <div class="info-block">
                    ...
                    <p><strong>Fecha de Venta:</strong>
                        {{ $cuenta->venta->fecha ? $cuenta->venta->fecha->format('d/m/Y') : $cuenta->venta->created_at->format('d/m/Y') }}
                    </p>
            ...
            @if ($cuenta && $cuenta->venta->notas && !str_contains(strtolower($cuenta->venta->notas), 'generado desde'))
                <div
        ...
        @else
            <div class="info-section">
                <div class="info-block">
                    ...
                    <p><strong>Fecha de Venta:</strong>
                        {{ $venta->fecha ? $venta->fecha->format('d/m/Y') : $venta->created_at->format('d/m/Y') }}</p>
